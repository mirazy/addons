...
const CONST = {
  ...
  // 기기별 상태 및 제어 코드(HEX)
  DEVICE: [
    {deviceId: 'Ventilator', subId: ''   , state: 'OFF', st: 'off', name: '환풍기'   , stateHex: new Buffer([0xf7, 0x0c, 0x01, 0x2b, 0x04, 0x41, 0x2b, 0x04, 0x40, 0x11, 0x00, 0x02, 0x07, 0x81]), commandHex: new Buffer([0xf7, 0x0b, 0x01, 0x2b, 0x02, 0x40, 0x11, 0x02, 0x00, 0x87, 0xee])}, //꺼짐
    {deviceId: 'Ventilator', subId: ''   , state: 'ON' , st: 'on' , name: '환풍기'   , stateHex: new Buffer([0xf7, 0x0c, 0x01, 0x2b, 0x04, 0x41, 0x2b, 0x04, 0x40, 0x11, 0x00, 0x01, 0x07, 0x82]), commandHex: new Buffer([0xf7, 0x0b, 0x01, 0x2b, 0x02, 0x42, 0x11, 0x07, 0x00, 0x80, 0xee])}, //켜짐(강)
    {deviceId: 'Ventilator', subId: ''   , state: 'ON2', st: 'on' , name: '환풍기'   , stateHex: new Buffer([0xf7, 0x0c, 0x01, 0x2b, 0x04, 0x41, 0x2b, 0x04, 0x40, 0x11, 0x00, 0x01, 0x03, 0x86]), commandHex: new Buffer([0xf7, 0x0b, 0x01, 0x2b, 0x02, 0x42, 0x11, 0x03, 0x00, 0x84, 0xee])}, //켜짐(중)
    {deviceId: 'Ventilator', subId: ''   , state: 'ON3', st: 'on' , name: '환풍기'   , stateHex: new Buffer([0xf7, 0x0c, 0x01, 0x2b, 0x04, 0x41, 0x2b, 0x04, 0x40, 0x11, 0x00, 0x01, 0x01, 0x84]), commandHex: new Buffer([0xf7, 0x0b, 0x01, 0x2b, 0x02, 0x42, 0x11, 0x01, 0x00, 0x86, 0xee])} //켜짐(약)
